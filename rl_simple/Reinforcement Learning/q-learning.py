...
if __name__ == '__main__':
    ...
    for it in range(100):
        ...
        while not grid.game_over():
            ...
            a2, max_q_s2a2 = max_dict(Q[s2])  # you take the action with the highest Q for the next state (s2)
            print("Best Next Action is: {}".format(a2))
            Q[s][a] = Q[s][a] + alpha * (r + GAMMA * max_q_s2a2 - Q[s][a])    # update Q
